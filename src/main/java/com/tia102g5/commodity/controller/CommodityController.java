...
//    可能需要添加更多的方法來處理特定的查詢或操作。
    ...
    public String listActivityCommodities(@RequestParam("activityID") Integer activityID, Model model) {
...
//    }
    ...
    public String setPostTime(@RequestParam("postTime") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime postTime) {
        // 實現設置上架時間的邏輯
...
//    }
    ...
    public String listCommoditiesByActivity(@PathVariable Integer activityID, Model model) {
        List<Commodity> commodities = commoditySvc.getCommoditiesByActivity(activityID);
        model.addAttribute("commodities", commodities);
        return "back-end-partner/commodity/commodityByActivity"; // 您需要創建這個新的視圖
//        return "back-end-partner/commodity/commodity";
